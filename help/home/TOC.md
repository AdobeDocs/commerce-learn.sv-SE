...
+ Adobe Commerce Cloud {#adobe-commerce-cloud}
   ...
   + [Marknadsföringsflöden](../cloud/marketing-flows.md)
   + [Alternativ för Storefront](../cloud/storefront-options.md)
   + [Datautbyte](../cloud/data-sharing.md)
   + [Flera webbplatser](../cloud/multiple-websites.md)
   + [Upplev data och kampanjer om leads](../cloud/experience-lead-data-promoitions.md)
...
+ Utbyggbarhet {#extensibility}
   + Back-end Development {#backend-development}
      + [Bästa praxis för att ändra databastabeller](https://experienceleague.adobe.com/docs/commerce-operations/implementation-playbook/best-practices/development/modifying-core-and-third-party-tables.html?lang=sv-SE)
...
+ Butiksadministration {#admin}
   ...
   + [Återställ administratörs-URI](../site-management/reset-admin-uri.md)
   + [Leveranssätt](../site-management/shipping-delivery.md)
   + [Administratörsstödraster och -filter](../site-management/admin-grids-and-filters.md)
...
+ Verktyg och externa tjänster {#tools}
   ...
   + [Patcheringstjänst för molnautomatisering](../tools/cloud-automation-patching-service.md)
   ...
   + New Relic {#new-relic}
      ...
      + [Anpassade aviseringar](../new-relic/custom-alerts.md)
