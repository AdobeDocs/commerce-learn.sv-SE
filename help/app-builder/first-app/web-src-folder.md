...
* Utvecklare som är nybörjare i Adobe Commerce med begränsad erfarenhet av Adobe App Builder och som håller på att lära sig om mappen `web-src` och dess innehåll.
